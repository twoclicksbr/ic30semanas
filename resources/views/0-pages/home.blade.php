                    ...
                    <div class="col-xl-11 col-xxl-10 mx-auto">
                        ...
                        <div class="row gy-6 text-center">
                            ...
                            <div class="col-md-6 col-lg-3">
                                ...
                                <img class="mb-4" src="/assets/30semanas/img/decisoes/01-adminitir.png"
                                    width="50%">
                            ...
                            <div class="col-md-6 col-lg-3">
                                ...
                                <img class="mb-4" src="/assets/30semanas/img/decisoes/02-confiar.png"
                                    width="50%">
                            ...
                            <div class="col-md-6 col-lg-3">
                                ...
                                <img class="mb-4" src="/assets/30semanas/img/decisoes/03-entregar.png"
                                    width="50%">
                            ...
                            <div class="col-md-6 col-lg-3">
                                ...
                                <img class="mb-4" src="/assets/30semanas/img/decisoes/04-depender.png"
                                    width="50%">
                            ...
                            <div class="col-md-6 col-lg-3">
                                ...
                                <img class="mb-4" src="/assets/30semanas/img/decisoes/05-obedecer.png"
                                    width="50%">
                            ...
                            <div class="col-md-6 col-lg-3">
                                ...
                                <img class="mb-4" src="/assets/30semanas/img/decisoes/06-confessar.png"
                                    width="50%">
                            ...
                            <div class="col-md-6 col-lg-3">
                                ...
                                <img class="mb-4" src="/assets/30semanas/img/decisoes/07-reparar.png"
                                    width="50%">
                            ...
                            <div class="col-md-6 col-lg-3">
                                ...
                                <img class="mb-4" src="/assets/30semanas/img/decisoes/08-compartilhar.png"
                                    width="50%">
            ...
            <div class="row gx-lg-0 gy-10 mb-5 mb-md-10 align-items-center">
                <div class="col-lg-6 text-center">
                    ...
                    <video width="70%" controls=""
                        ...
                        <source src="{{ asset('/assets/30semanas/img/null923.mp4') }}" type="video/mp4">
