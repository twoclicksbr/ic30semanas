<footer id="contact" class="bg-dark ">
    <div class="container pb-13 pb-md-15">
        <div class="card image-wrapper bg-full bg-image bg-overlay mt-n50p mx-md-5"
            data-image-src="{{ asset('/assets/30semanas/img/photos/bg27.jpg') }}"
            style="background-image: url('/assets/30semanas/img/photos/bg27.jpg');">
            <div
                ...
                <img src="{{ asset('/assets/30semanas/30/rede_inspire.png') }}" width="150">
            ...
            <div class="row gy-6 gy-lg-0">
                <div class="col-md-4 col-lg-3">
                    <div class="widget">
                        ...
                        <img class="mb-4" src="{{ asset('/assets/30semanas/30/footer-logo.png') }}"
                            srcset="{{ asset('/assets/30semanas/30/footer-logo.png') }}" alt="">

                        <p class="mb-4">© 2025 | 30 Semanas. <br class="d-none d-lg-block">Todos os Direitos
                            Reservados.</p>

                        <img class="mb-4" width="200"
                            src="{{ asset('assets/30semanas/30/footer_logo_ic_branco.png') }}"
                            srcset="{{ asset('/assets/30semanas/30/footer_logo_ic_branco.png') }}"
                            alt="">
