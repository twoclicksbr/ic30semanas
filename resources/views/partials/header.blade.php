        ...
        <div class="container flex-lg-row flex-nowrap align-items-center">
            ...
            <div class="navbar-brand w-100">
                <a href="{{ url('/') }}" class="logo">
                    <img class="logo-light" src="{{ asset('assets/30semanas/30/logo.png') }}"
                        srcset="{{ asset('assets/30semanas/30/logo@2x.png 2x') }}" alt="Logo">
                    <img class="logo-dark" src="{{ asset('assets/30semanas/30/logo-light.png') }}"
                        srcset="{{ asset('assets/30semanas/30/logo-light@2x.png 2x') }}" alt="Logo">
                </a>
            </div>
